...
contract PixelSproutNft is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("PixelSprout", "PXSp") {}
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "PixelSprout #',
                        Strings.toString(tokenId),
                        '", "description": "An in-game plant spirits", "image": "data:image/svg+xml;base64,',
